...
<script>
    function giris(){
      <% String email = request.getParameter("email"); 
         ...
         String girisBilgi = dbkatmani.getOgretmenGiris(email);
         if (girisBilgi.equals(password)) {
            String isim = dbkatmani.getOgretmenIsim(email);;
            session.setAttribute("email", email);
            session.setAttribute("username", isim);
            response.sendRedirect("ogretmenAnaSayfa.jsp"); 
