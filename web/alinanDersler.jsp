...
<%
   ...
   String [][] dersler = dbkatmani.getAlinanDersler(email, sonDonem);
   int rowCount = dersler.length;
   int colCount = dersler[0].length;
%>
<body>
    <div class="top-panel">
        <div class="logo">
    ...
    <div class="container">
        <div class="user-panel">
            <label for="interests">Dönem:</label>
...
<script>
    function secim(selectElement) {
        ...
        if (selectedValue !== null) {
            window.location.href = "getDersler.jsp?selectedValue=" + selectedValue + "&selectedOptionIndex=" + selectedOptionIndex;
        }
    }
