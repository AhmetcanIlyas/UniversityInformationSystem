...
<%
   ...
   String[] bilgiler = dbkatmani.getOgrenciProfil(email);
%>
<body>
    <div class="top-panel">
        <div class="logo">
    ...
    <div class="container">
        <div class="user-panel">
            ...
            <div class="user-options">
                <a href="ogrenciProfil.jsp">Profil</a>
            ...
            <div class="main-content">
                ...
                <div class="profile-info">
                    <div class="info-block">
                        <div class="info-title">Fakülte:</div>
                        <div><%=bilgiler[2]%></div>
                    </div>
                    <div class="info-block">
                        <div class="info-title">Bölüm:</div>
                        <div><%=bilgiler[3]%></div>
                    </div>
                    <div class="info-block">
                        <div class="info-title">Dönem:</div>
                        <div><%=bilgiler[7]%></div>
                    </div>
                </div>
            </div>
